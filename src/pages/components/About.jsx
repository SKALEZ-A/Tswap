    ...
    <Box className="container" mx="auto" px={{ base: 4, lg: 0 }} bg="transparent" zIndex={99}>
      {/* About Section */}
        <Box w={{ lg: "70%" }} mx="auto" >
          ...
          WELCOME TO  <span style={{fontWeight:"bold"}}>CANDYSWAP</span> 
          </Text>
    
          <Flex  direction={{ base: "column", lg: "row" }} >
            {/* Left Content */}
            <Box w={{ base: "full"}} order={{ base: 2, lg: 1 }} mt={{ base: 2, lg: 0 }}>
              ...
              <Text mt={5} color="white" fontWeight="bold" fontSize={{ base: "14px", lg: "3xl" }}>
